...
func InitStartBackup(ie error, dc chan error, ec chan logger.LogRecord, w time.Duration, jn string, j map[string]interfaces.Job, fj, dj, ej interfaces.Jobs) *StartBackup {
	return &StartBackup{
		initErr:  ie,
		done:     dc,
		evCh:     ec,
